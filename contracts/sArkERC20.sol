...
contract sArk is ERC20Permit, Policy {
    ...
    constructor()
    ERC20("Staked Ark", "sArk", 9)
    ERC20Permit("Staked Ark") {
    ...
    /**
        @notice increases sArk supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sArk
